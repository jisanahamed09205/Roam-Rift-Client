...
const PackageCard = ({popularData}) => {
    const {_id,img,tour_type,title,price} = popularData;
    return (
      ...
      //     </div>
      //     <Link className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
      //       View Package
