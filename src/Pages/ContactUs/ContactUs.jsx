...
const ContactUs = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Roam Rift || Contact Us</title>
            </Helmet>
            <section className="py-6 bg-green-200 dark:bg-gray-800 dark:text-gray-50">
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    <div className="py-6 md:py-0 md:px-6">
                        ...
                        <div className="space-y-4">
                            <p className="flex items-center">
                                ...
                                <span>Lake address, 9999 Rome City</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                    ...
                    {/* <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button type="button" className="btn btn-outline self-center px-8 py-3 text-lg rounded ">Submit</button>
                    </form> */}
