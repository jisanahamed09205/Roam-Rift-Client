    ...
    return (
        ...
        <div className="bg-white p-8 shadow-md rounded-lg mx-auto max-w-md">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-gray-600">{guideData?.description}</p>
            <div className="mt-4">
              <p className="text-lg font-semibold mb-2">
                {guideData?.experience} Years of Experience
              </p>
              <p className="text-lg font-semibold mb-2">Email: {guideData?.contact?.service_provider_email}</p>
              <p className="text-lg font-semibold">Phone: {guideData?.contact?.service_provider_phone}</p>
            </div>
          </div>
          <div></div>
        </div>
